...
namespace Websitecourse.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            ViewBag.UserType = new SelectList(db.Roles.Where(m =>!m.Name.Contains("Administrators")).ToList(),"Name","Name");
            return View();
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // add user to role many to many relationship between user and role
        ...
        public ActionResult EditProfile()
        {
            ...
            var user = db.Users.Where(m => m.Id == UserID).SingleOrDefault();
        ...
        {
            var UserID = User.Identity.GetUserId();
            var Currentuser = db.Users.Where(m => m.Id == UserID).SingleOrDefault();
            ...
            else
            {
                ...
                db.SaveChanges();
                ViewBag.Message = "Update Password succesed ";
            }
        ...
        public async Task<ActionResult> SendCode(SendCodeViewModel model)
        {
            ...
            return RedirectToAction("VerifyCode", new { Provider = model.SelectedProvider, ReturnUrl = model.ReturnUrl, reRememberMe = model.RememberMe });
        }
